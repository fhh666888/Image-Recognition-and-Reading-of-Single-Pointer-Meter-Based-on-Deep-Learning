...
parser.add_argument('--trainroot', default='E:\\data\\train_lmdb', help='path to dataset')
parser.add_argument('--valroot', default='E:\\data\\test_lmdb', help='path to dataset')
...
parser.add_argument('--cuda', default='0', help='enables cuda')
parser.add_argument('--ngpu', type=int, default=1, help='number of GPUs to use')
parser.add_argument('--pretrained', default='./data11/crnn.pth', help="path to pretrained model (to continue training)")
...
#   rnn[1].embedding = nn.Linear(512, 12)
    #print(crnn)
    pre_weights = torch.load(opt.pretrained, map_location='cpu')

    # delete classifier weights
    pre_dict = {k: v for k, v in pre_weights.items() if crnn.state_dict()[k].numel() == v.numel()}

    crnn.load_state_dict(pre_dict,strict=False)
    #crnn.rnn[1].embedding = nn.Linear(512, 12)
#print(crnn)
